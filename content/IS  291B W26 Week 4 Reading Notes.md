---
title: IS  291B W26 Week 4 Reading Notes
draft: "false"
tags:
  - class-notes
  - information-studies
...
$\text{Quantity} \leftrightarrow \text{Quality}$
> [!note] Note
...
> [!note] Note
> Def: Decalcomania
> The process of transferring designs from prepared paper onto porcelain or some other material
...
- Tracing $\to$ abstraction, closed logics, self reproduction, flat
- Mapping $\to$ Experimentation and contact, constant modification
...
- Change in dimension $\to$ change in nature
- Made of only lines
